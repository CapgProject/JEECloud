...
-- Dumping data for table project.book_master: ~9 rows (approximately)
...
-- Dumping data for table project.book_transactions: ~8 rows (approximately)
...
-- Dumping data for table project.department_master: ~5 rows (approximately)
...
-- Dumping data for table project.designation_master: ~6 rows (approximately)
...
-- Dumping data for table project.emp: ~14 rows (approximately)
DELETE FROM `emp`;
...
-- Dumping data for table project.staff_master: ~0 rows (approximately)
DELETE FROM `staff_master`;
/*!40000 ALTER TABLE `staff_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `staff_master` ENABLE KEYS */;

-- Dumping data for table project.student_marks: ~42 rows (approximately)
...
-- Dumping data for table project.student_master: ~21 rows (approximately)
